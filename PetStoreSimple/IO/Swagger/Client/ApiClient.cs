...
namespace IO.Swagger.Client
{
    ...
    public class ApiClient
    {
        ...
        /// with default configuration and base path (http://petstore.swagger.io/api).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("http://petstore.swagger.io/api");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://petstore.swagger.io/api).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://petstore.swagger.io/api")
        {
